...
if __name__ == '__main__':
    ...
    parser.add_argument('--partition', default="noniid-labeldir", type=str, help='partition methods')
    parser.add_argument('--device', default="cuda:2", type=str, help='partition methods')
    parser.add_argument('--dataset', default="femnist", type=str, help='dataset name')
    parser.add_argument('--split', default="femnist", type=str)
    parser.add_argument('--party_num', default=3597, type=int)
    parser.add_argument('--batch', default=301, type=int, help='')
    parser.add_argument('--model', default="resnet18", type=str, help='model name')
    parser.add_argument('--input_channels', default=1, type=int, help='')
    parser.add_argument('--num_classes', default=62, type=int, help='')
    ...
    if args.index != -1:
        ...
        test_feature, test_target = convert_dataset(args, test_feature, test_target)
    if args.party_num < 1000:
        test_whole_feature, test_whole_target = get_whole_test_set(args.index, args.partition, args.party_num,
