...
# layer=$8
# name=$9
echo $batch, $batch_ensemble, $model, $selection_method, $normalization, $avg, $input_channels, $num_classes

# baselines
bash batch_ensemble_baselines_cifar100.sh $batch $batch_ensemble $model
# last_layer
bash batch_ensemble_clustering_cifar100.sh $batch $batch_ensemble noDimensionReduction $model 0 $selection_method 1 0 "last_layer"
# fed_avg and mean_avg
bash batch_ensemble_avg_cifar100.sh $batch $batch_ensemble fed_avg $device $model
bash batch_ensemble_avg_cifar100.sh $batch $batch_ensemble mean_avg $device $model
...
# PCA
bash batch_ensemble_clustering_cifar100.sh $batch $batch_ensemble PCA $model 0 $selection_method 1 0 "PCA"
# Kernel_PCA
bash batch_ensemble_clustering_cifar100.sh $batch $batch_ensemble Kernel_PCA $model 0 $selection_method 1 0 "Kernel_PCA"
# layer 1
...
# layer 2
bash batch_ensemble_clustering_cifar100.sh $batch $batch_ensemble noDimensionReduction $model 0 $selection_method 0 2 "layer_2"
# layer 3
bash batch_ensemble_clustering_cifar100.sh $batch $batch_ensemble noDimensionReduction $model 0 $selection_method 0 3 "layer_3"
# layer -1
bash batch_ensemble_clustering_cifar100.sh $batch $batch_ensemble noDimensionReduction $model 0 $selection_method 0 -1 "layer_-1"
# CV Selection Method
bash batch_ensemble_clustering_cifar100.sh $batch $batch_ensemble noDimensionReduction $model 0 "CV" 1 0 "last_layer_CV"
# data Selection Method
bash batch_ensemble_clustering_cifar100.sh $batch $batch_ensemble noDimensionReduction $model 0 "data" 1 0 "last_layer_data"
# original
bash batch_ensemble_clustering_cifar100.sh $batch $batch_ensemble noDimensionReduction $model 0 $selection_method 0 0 "original"
